...
class AuctionServer(object):
    def __init__(self, host="localhost", ports=8020, numbidders=2, neededtowin=5, itemtypes=['Picasso', 'Van_Gogh', 'Rembrandt', 'Da_Vinci'], numitems={}, auction_size=200, budget=1000, values={}, announce_order=True, winner_pays=0):
        self.host = host
