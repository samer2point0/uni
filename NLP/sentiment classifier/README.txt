...
2- Resources:
    ...
    glove 50 dimensions w2vec file (glove.twitter.27B.50d.txt) http://nlp.stanford.edu/data/glove.twitter.27B.zip
...
5- Notes:
  ...
  * Some areas of the code are commented out and these are left there mainly to show how the pickled objects
    ...
    were generated, no conditional statement were implemented, and the comments will need to be removed by manually,
    to run the code. These were highlighted for clarity.
